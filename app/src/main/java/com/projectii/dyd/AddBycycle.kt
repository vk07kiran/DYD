...
class AddBycycle : AppCompatActivity() {
    ...
    private lateinit var addBycycleButton: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.add_bycycle)
        ...
        etFullModelName = findViewById(R.id.fullBycycleModelNameEditText)
        spinnerCategory = findViewById(R.id.spinner_filter1)
        etAmount = findViewById(R.id.amountEditText)
        etLocation = findViewById(R.id.LocationEditText)
        etPurchasedDate = findViewById(R.id.BycyclePurchasedDateEditText)
        etEsewa = findViewById(R.id.esewaPlateEditText)


        addBycycleButton = findViewById(R.id.addBycycle_button)
        ...
        addBycycleButton.setOnClickListener {
            addBycycle()
        }
    }
    ...
    private fun addBycycle() {
        ...
        if (modelName.isEmpty() || amount.isEmpty() || location.isEmpty() || purchasedDate.isEmpty() || categoryName.isEmpty()||esewa.isEmpty()) {
        ...
        if (imageUri != null) {
            uploadImageAndSaveVehicle(modelName, categoryName, purchasedDate, amount, location,esewa)
        } else {
            overlayView.visibility = View.GONE
    ...
    private fun uploadImageAndSaveVehicle(modelName: String, categoryName: String, purchasedDate: String, amount: String, location: String, esewa: String) {
        val overlayView = findViewById<View>(R.id.overlayView)
        overlayView.visibility = View.VISIBLE
            ...
            fileReference.putFile(it)
                .addOnSuccessListener {
                    fileReference.downloadUrl.addOnSuccessListener { uri ->
                        saveVehicleToFirestore(modelName, categoryName, purchasedDate, amount, location,esewa, uri.toString())
                    }
                }
    ...
    private fun saveVehicleToFirestore(modelName: String, categoryName: String, purchasedDate: String, amount: String, location: String, esewa:String, imageUrl: String) {
        val overlayView = findViewById<View>(R.id.overlayView)
        overlayView.visibility = View.VISIBLE
