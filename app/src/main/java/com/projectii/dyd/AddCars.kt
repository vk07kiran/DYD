...
class AddCars : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.add_cars)
        ...
        etFullModelName = findViewById(R.id.fullCarModelNameEditText)
        spinnerCategory = findViewById(R.id.spinner_filter2)
        etNumberPlate = findViewById(R.id.NumberPlateEditText)
        etPurchasedDate = findViewById(R.id.CarPurchasedDateEditText)
